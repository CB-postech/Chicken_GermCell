...
hs_norm = pd.read_csv(os.path.join(data_dir, "hs_female_logcd_hvg.csv"), sep=",", index_col=0)
hs_norm_allgene = pd.read_csv(os.path.join(data_dir, "hs_female_logcd.csv"), sep=",", index_col=0)
...
pr_res = palantir.core.run_palantir(hs_ms, start_cell, num_waypoints=250)
